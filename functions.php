...
if ( ! function_exists( 'gulp_wordpress_setup' ) ) :
	...
	function gulp_wordpress_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'gulp-wordpress' ),
		) );
...
//	wp_enqueue_script( 'gulp-wordpress-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
